...
## 2. Review Guidelines
- **Show Code for Review**: Once you finish writing, editing, or refactoring code, always show the exact code snippets or diffs to the user for review. Never assume a task is complete without showing what was changed and why.
